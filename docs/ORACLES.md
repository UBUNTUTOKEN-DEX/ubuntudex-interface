...
Currently there is two types of oracles which the sushi interface supports, Chainlink & Ubuntu TWAP.
...
If a newly added token is not in the ubuntudefaulttoken, it should be added.
