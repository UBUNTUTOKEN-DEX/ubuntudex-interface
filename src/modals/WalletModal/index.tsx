    ...
    <HeadlessUiModal.Controlled isOpen={walletModalOpen} onDismiss={toggleWalletModal} maxWidth="md">
      {error ? (
        ...
        <div className="flex flex-col w-full space-y-4">
          <HeadlessUiModal.Header
            header={i18n._(t`Connect Wallet`)}
            onClose={toggleWalletModal}
          ...
          {walletView === WALLET_VIEWS.PENDING ? (
            ...
            <div className="grid grid-cols-1 gap-4 overflow-y-auto md:grid-cols-1 height_400">{options}</div>
          )}
          <div className="flex justify-center">
            <Typography variant="xs" className="text-secondary" component="span">
              {i18n._(t`Access the marketplace`)}{' '}
              <Typography variant="xs" className="text-blue" component="span">
                <ExternalLink href="https://ethereum.org/wallets/" color="gold">
                  {i18n._(t`using your favourite wallet`)}
                </ExternalLink>
              </Typography>
            </Typography>
          </div>
